...
/// </summary>
/// <remarks>
///     This is useful for draggable foldouts and toggles, like the headers of Components in the inspector,
///     that only process the click on MouseUp when the mouse is not dragged.
/// </remarks>
public class DragAndClickManipulator : MouseManipulator
{
    ...
    public DragAndClickManipulator(Action onStartDragging, Action onProcessClick) : this()
    {
